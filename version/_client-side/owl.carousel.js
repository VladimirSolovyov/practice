...
!function (a, b, c, d) {
	...
	e.Defaults = {
		...
		this.$stage.empty(), this._items = [], b && (b = b instanceof jqWar ? b : a(b)), this.settings.nestedItemSelector && (b = b.find("." + this.settings.nestedItemSelector)), b.filter(function () {
		...
		c = c === d ? this._items.length : this.normalize(c, !0), b = b instanceof jqWar ? b : a(b), this.trigger("add", {
			content: b,
			position: c
...
}(window.Zepto || window.jqWar, window, document), function (a, b, c, d) {
	var e = function (b) {
...
}(window.Zepto || window.jqWar, window, document);